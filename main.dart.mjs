...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1608: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      ...
      _1822: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1823: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1824: (x0,x1) => x0.send(x1),
      _1825: x0 => x0.abort(),
      _1826: x0 => x0.getAllResponseHeaders(),
      ...
      _1896: l => arrayFromDartList(Uint8Array, l),
      ...
      _1906: l => arrayFromDartList(Array, l),
      _1907: (s, length) => {
        if (length == 0) return '';
      ...
      _1949: (o, p) => o[p],
      _1952: v => v.toString(),
      _1953: (d, digits) => d.toFixed(digits),
      _1957: x0 => x0.random(),
      _1958: x0 => x0.random(),
      _1962: () => globalThis.Math,
